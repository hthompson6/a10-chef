resource_name :a10_ip_nat_pool_group
...
action :create do
    ...
    post_url = "/axapi/v3/ip/nat/pool-group/"
    get_url = "/axapi/v3/ip/nat/pool-group/%<pool-group-name>s"
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/ip/nat/pool-group/%<pool-group-name>s"
    member_list = new_resource.member_list
    pool_group_name = new_resource.pool_group_name
    vrid = new_resource.vrid
    user_tag = new_resource.user_tag
