resource_name :a10_sys_ut_event_action_ignore_validation
...
action :create do
    ...
    get_url = "/axapi/v3/sys-ut/event/%<event-number>s/action/%<direction>s/ignore-validation"
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/sys-ut/event/%<event-number>s/action/%<direction>s/ignore-validation"
    all = new_resource.all
    uuid = new_resource.uuid
    l4 = new_resource.l4
    l2 = new_resource.l2
