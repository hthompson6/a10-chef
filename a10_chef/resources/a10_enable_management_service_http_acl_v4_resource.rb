resource_name :a10_enable_management_service_http_acl_v4
...
action :create do
    ...
    post_url = "/axapi/v3/enable-management/service/http/acl-v4/"
    get_url = "/axapi/v3/enable-management/service/http/acl-v4/%<acl-id>s"
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/enable-management/service/http/acl-v4/%<acl-id>s"
    tunnel_cfg = new_resource.tunnel_cfg
    management = new_resource.management
    uuid = new_resource.uuid
    user_tag = new_resource.user_tag
