resource_name :a10_router_bgp_redistribute
...
action :create do
    ...
    post_url = "/axapi/v3/router/bgp/%<as-number>s/"
    get_url = "/axapi/v3/router/bgp/%<as-number>s/redistribute"
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/router/bgp/%<as-number>s/redistribute"
    ip_nat_list_cfg = new_resource.ip_nat_list_cfg
    lw4o6_cfg = new_resource.lw4o6_cfg
    uuid = new_resource.uuid
    connected_cfg = new_resource.connected_cfg
