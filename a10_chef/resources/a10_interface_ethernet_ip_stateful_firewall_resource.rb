resource_name :a10_interface_ethernet_ip_stateful_firewall
...
action :create do
    ...
    post_url = "/axapi/v3/interface/ethernet/%<ifnum>s/ip/"
    get_url = "/axapi/v3/interface/ethernet/%<ifnum>s/ip/stateful-firewall"
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/interface/ethernet/%<ifnum>s/ip/stateful-firewall"
    uuid = new_resource.uuid
    class_list = new_resource.class_list
    inside = new_resource.inside
    outside = new_resource.outside
