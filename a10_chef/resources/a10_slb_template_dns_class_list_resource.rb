resource_name :a10_slb_template_dns_class_list
...
action :create do
    ...
    post_url = "/axapi/v3/slb/template/dns/%<name>s/"
    get_url = "/axapi/v3/slb/template/dns/%<name>s/class-list"
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/slb/template/dns/%<name>s/class-list"
    lid_list = new_resource.lid_list
    a10_name = new_resource.a10_name
    uuid = new_resource.uuid
