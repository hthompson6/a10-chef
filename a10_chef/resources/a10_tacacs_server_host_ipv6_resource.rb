resource_name :a10_tacacs_server_host_ipv6
...
action :create do
    ...
    post_url = "/axapi/v3/tacacs-server/host/ipv6/"
    get_url = "/axapi/v3/tacacs-server/host/ipv6/%<ipv6-addr>s"
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/tacacs-server/host/ipv6/%<ipv6-addr>s"
    secret = new_resource.secret
    ipv6_addr = new_resource.ipv6_addr
    uuid = new_resource.uuid
