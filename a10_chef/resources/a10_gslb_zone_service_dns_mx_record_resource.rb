resource_name :a10_gslb_zone_service_dns_mx_record
...
action :create do
    ...
    post_url = "/axapi/v3/gslb/zone/%<name>s/service/%<service-port>s+%<service-name>s/dns-mx-record/"
    get_url = "/axapi/v3/gslb/zone/%<name>s/service/%<service-port>s+%<service-name>s/dns-mx-record/%<mx-name>s"
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/gslb/zone/%<name>s/service/%<service-port>s+%<service-name>s/dns-mx-record/%<mx-name>s"
    priority = new_resource.priority
    sampling_enable = new_resource.sampling_enable
    uuid = new_resource.uuid
    mx_name = new_resource.mx_name
