resource_name :a10_cgnv6_lsn_radius_server
...
property :disable_reply, [true, false]
property :accounting_interim_update, ['ignore','append-entry','replace-entry']
property :secret, [true, false]
property :sampling_enable, Array
property :accounting_stop, ['ignore','delete-entry','delete-entry-and-sessions']
...
action :create do
    ...
    post_url = "/axapi/v3/cgnv6/lsn/radius/"
    get_url = "/axapi/v3/cgnv6/lsn/radius/server"
    ...
    disable_reply = new_resource.disable_reply
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/cgnv6/lsn/radius/server"
    accounting_start = new_resource.accounting_start
    attribute_name = new_resource.attribute_name
    vrid = new_resource.vrid
    remote = new_resource.remote
