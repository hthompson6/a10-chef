resource_name :a10_ip_community_list_expanded_num
...
action :create do
    ...
    post_url = "/axapi/v3/ip/community-list/expanded-num/"
    get_url = "/axapi/v3/ip/community-list/expanded-num/%<ext-list-num>s"
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/ip/community-list/expanded-num/%<ext-list-num>s"
    ext_list_num = new_resource.ext_list_num
    rules_list = new_resource.rules_list
    uuid = new_resource.uuid
