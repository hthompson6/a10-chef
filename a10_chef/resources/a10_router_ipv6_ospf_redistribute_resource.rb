resource_name :a10_router_ipv6_ospf_redistribute
...
action :create do
    ...
    get_url = "/axapi/v3/router/ipv6/ospf/%<process-id>s/redistribute"
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/router/ipv6/ospf/%<process-id>s/redistribute"
    redist_list = new_resource.redist_list
    ospf_list = new_resource.ospf_list
    uuid = new_resource.uuid
    ip_nat_floating_list = new_resource.ip_nat_floating_list
