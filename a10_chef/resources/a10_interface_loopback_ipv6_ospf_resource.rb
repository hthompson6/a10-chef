resource_name :a10_interface_loopback_ipv6_ospf
...
action :create do
    ...
    post_url = "/axapi/v3/interface/loopback/%<ifnum>s/ipv6/"
    get_url = "/axapi/v3/interface/loopback/%<ifnum>s/ipv6/ospf"
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/interface/loopback/%<ifnum>s/ipv6/ospf"
    uuid = new_resource.uuid
    bfd = new_resource.bfd
    cost_cfg = new_resource.cost_cfg
    hello_interval_cfg = new_resource.hello_interval_cfg
