resource_name :a10_sys_ut_event_action_l2
...
action :create do
    ...
    get_url = "/axapi/v3/sys-ut/event/%<event-number>s/action/%<direction>s/l2"
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/sys-ut/event/%<event-number>s/action/%<direction>s/l2"
    protocol = new_resource.protocol
    uuid = new_resource.uuid
    ethertype = new_resource.ethertype
    mac_list = new_resource.mac_list
