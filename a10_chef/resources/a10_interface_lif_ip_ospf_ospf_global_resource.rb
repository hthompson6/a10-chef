resource_name :a10_interface_lif_ip_ospf_ospf_global
...
action :create do
    ...
    post_url = "/axapi/v3/interface/lif/%<ifnum>s/ip/ospf/"
    get_url = "/axapi/v3/interface/lif/%<ifnum>s/ip/ospf/ospf-global"
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/interface/lif/%<ifnum>s/ip/ospf/ospf-global"
    cost = new_resource.cost
    dead_interval = new_resource.dead_interval
    authentication_key = new_resource.authentication_key
    network = new_resource.network
