resource_name :a10_cgnv6_template_dns_class_list_lid
...
action :create do
    ...
    post_url = "/axapi/v3/cgnv6/template/dns/%<name>s/class-list/lid/"
    get_url = "/axapi/v3/cgnv6/template/dns/%<name>s/class-list/lid/%<lidnum>s"
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/cgnv6/template/dns/%<name>s/class-list/lid/%<lidnum>s"
    action_value = new_resource.action_value
    log = new_resource.log
    lidnum = new_resource.lidnum
    over_limit_action = new_resource.over_limit_action
