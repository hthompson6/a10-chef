resource_name :a10_ip_extcommunity_list_standard_num
...
action :create do
    ...
    post_url = "/axapi/v3/ip/extcommunity-list/standard-num/"
    get_url = "/axapi/v3/ip/extcommunity-list/standard-num/%<std-list-num>s"
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/ip/extcommunity-list/standard-num/%<std-list-num>s"
    rules_list = new_resource.rules_list
    uuid = new_resource.uuid
    std_list_num = new_resource.std_list_num
