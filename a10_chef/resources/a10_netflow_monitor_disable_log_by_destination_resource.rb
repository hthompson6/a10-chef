resource_name :a10_netflow_monitor_disable_log_by_destination
...
action :create do
    ...
    get_url = "/axapi/v3/netflow/monitor/%<name>s/disable-log-by-destination"
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/netflow/monitor/%<name>s/disable-log-by-destination"
    udp_list = new_resource.udp_list
    icmp = new_resource.icmp
    uuid = new_resource.uuid
    tcp_list = new_resource.tcp_list
