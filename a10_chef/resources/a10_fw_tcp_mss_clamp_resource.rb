resource_name :a10_fw_tcp_mss_clamp

property :a10_name, String, name_property: true
property :mss_subtract, Integer
property :mss_value, Integer
property :mss_clamp_type, ['fixed','subtract']
...
action :create do
    ...
    post_url = "/axapi/v3/fw/tcp/"
    get_url = "/axapi/v3/fw/tcp/mss-clamp"
