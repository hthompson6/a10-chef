resource_name :a10_router_isis_address_family_ipv6_redistribute
...
action :create do
    ...
    post_url = "/axapi/v3/router/isis/%<tag>s/address-family/ipv6/"
    get_url = "/axapi/v3/router/isis/%<tag>s/address-family/ipv6/redistribute"
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/router/isis/%<tag>s/address-family/ipv6/redistribute"
    vip_list = new_resource.vip_list
    redist_list = new_resource.redist_list
    isis = new_resource.isis
    uuid = new_resource.uuid
