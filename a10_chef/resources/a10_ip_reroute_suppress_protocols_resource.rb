resource_name :a10_ip_reroute_suppress_protocols
...
action :create do
    ...
    post_url = "/axapi/v3/ip/reroute/"
    get_url = "/axapi/v3/ip/reroute/suppress-protocols"
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/ip/reroute/suppress-protocols"
    isis = new_resource.isis
    uuid = new_resource.uuid
    ospf = new_resource.ospf
    rip = new_resource.rip
