resource_name :a10_acos_events_log_server
...
action :create do
    ...
    post_url = "/axapi/v3/acos-events/log-server/"
    get_url = "/axapi/v3/acos-events/log-server/%<name>s"
    ...
    params = { "log-server": {"health-check-disable": health_check_disable,
        "port-list": port_list,
        "name": a10_name,
        "fqdn-name": fqdn_name,
        "host": host,
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/acos-events/log-server/%<name>s"
    health_check_disable = new_resource.health_check_disable
    port_list = new_resource.port_list
    a10_name = new_resource.a10_name
    fqdn_name = new_resource.fqdn_name
