resource_name :a10_interface_loopback_ipv6_router_ospf
...
action :create do
    ...
    get_url = "/axapi/v3/interface/loopback/%<ifnum>s/ipv6/router/ospf"
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/interface/loopback/%<ifnum>s/ipv6/router/ospf"
    area_list = new_resource.area_list
    uuid = new_resource.uuid
