resource_name :a10_cgnv6_lw_4o6_health_check_gateway
...
action :create do
    ...
    post_url = "/axapi/v3/cgnv6/lw-4o6/health-check-gateway/"
    get_url = "/axapi/v3/cgnv6/lw-4o6/health-check-gateway/%<ipv4-addr>s+%<ipv6-addr>s"
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/cgnv6/lw-4o6/health-check-gateway/%<ipv4-addr>s+%<ipv6-addr>s"
    ipv4_addr = new_resource.ipv4_addr
    ipv6_addr = new_resource.ipv6_addr
    uuid = new_resource.uuid
