resource_name :a10_cgnv6_map_translation_fragmentation_inbound

property :a10_name, String, name_property: true
property :frag_action, ['drop','ipv6']
...
action :create do
    ...
    get_url = "/axapi/v3/cgnv6/map/translation/fragmentation/inbound"
    frag_action = new_resource.frag_action
    df_set = new_resource.df_set
    uuid = new_resource.uuid

    params = { "inbound": {"frag-action": frag_action,
        "df-set": df_set,
        "uuid": uuid,} }
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/cgnv6/map/translation/fragmentation/inbound"
    frag_action = new_resource.frag_action
    df_set = new_resource.df_set
    uuid = new_resource.uuid
