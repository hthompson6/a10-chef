resource_name :a10_sys_ut_template_tcp
...
action :create do
    ...
    get_url = "/axapi/v3/sys-ut/template/%<name>s/tcp"
    ...
    params = { "tcp": {"src-port-range": src_port_range,
        "uuid": uuid,
        "checksum": checksum,
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/sys-ut/template/%<name>s/tcp"
    src_port_range = new_resource.src_port_range
    uuid = new_resource.uuid
    checksum = new_resource.checksum
    seq_number = new_resource.seq_number
