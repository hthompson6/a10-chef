resource_name :a10_interface_trunk_nptv6_domain
...
action :create do
    ...
    post_url = "/axapi/v3/interface/trunk/%<ifnum>s/nptv6/domain/"
    get_url = "/axapi/v3/interface/trunk/%<ifnum>s/nptv6/domain/%<domain-name>s+%<bind-type>s"
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/interface/trunk/%<ifnum>s/nptv6/domain/%<domain-name>s+%<bind-type>s"
    domain_name = new_resource.domain_name
    bind_type = new_resource.bind_type
    uuid = new_resource.uuid
