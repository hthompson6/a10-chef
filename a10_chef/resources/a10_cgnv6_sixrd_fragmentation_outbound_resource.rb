resource_name :a10_cgnv6_sixrd_fragmentation_outbound

property :a10_name, String, name_property: true
property :count, Integer
property :a10_action, ['drop','ipv6','send-icmp','send-icmpv6']
property :df_set, ['drop','ipv6','send-icmp','send-icmpv6']
...
action :create do
    ...
    get_url = "/axapi/v3/cgnv6/sixrd/fragmentation/outbound"
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/cgnv6/sixrd/fragmentation/outbound"
    count = new_resource.count
    a10_name = new_resource.a10_name
    df_set = new_resource.df_set
    uuid = new_resource.uuid
