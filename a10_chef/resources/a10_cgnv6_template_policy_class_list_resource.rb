resource_name :a10_cgnv6_template_policy_class_list
...
action :create do
    ...
    post_url = "/axapi/v3/cgnv6/template/policy/%<name>s/"
    get_url = "/axapi/v3/cgnv6/template/policy/%<name>s/class-list"
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/cgnv6/template/policy/%<name>s/class-list"
    header_name = new_resource.header_name
    lid_list = new_resource.lid_list
    a10_name = new_resource.a10_name
    client_ip_l3_dest = new_resource.client_ip_l3_dest
