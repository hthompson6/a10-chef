resource_name :a10_router_ipv6_ospf_default_information
...
action :create do
    ...
    post_url = "/axapi/v3/router/ipv6/ospf/%<process-id>s/"
    get_url = "/axapi/v3/router/ipv6/ospf/%<process-id>s/default-information"
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/router/ipv6/ospf/%<process-id>s/default-information"
    originate = new_resource.originate
    uuid = new_resource.uuid
    always = new_resource.always
    metric = new_resource.metric
