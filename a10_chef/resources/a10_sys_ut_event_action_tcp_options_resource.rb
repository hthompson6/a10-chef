resource_name :a10_sys_ut_event_action_tcp_options
...
action :create do
    ...
    post_url = "/axapi/v3/sys-ut/event/%<event-number>s/action/%<direction>s/tcp/"
    get_url = "/axapi/v3/sys-ut/event/%<event-number>s/action/%<direction>s/tcp/options"
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/sys-ut/event/%<event-number>s/action/%<direction>s/tcp/options"
    uuid = new_resource.uuid
    mss = new_resource.mss
    sack_type = new_resource.sack_type
    time_stamp_enable = new_resource.time_stamp_enable
