resource_name :a10_ip_community_list_expanded
...
action :create do
    ...
    post_url = "/axapi/v3/ip/community-list/expanded/"
    get_url = "/axapi/v3/ip/community-list/expanded/%<expanded>s"
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/ip/community-list/expanded/%<expanded>s"
    expanded = new_resource.expanded
    rules_list = new_resource.rules_list
    uuid = new_resource.uuid
