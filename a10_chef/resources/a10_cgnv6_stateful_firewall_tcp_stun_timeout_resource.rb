resource_name :a10_cgnv6_stateful_firewall_tcp_stun_timeout
...
action :create do
    ...
    post_url = "/axapi/v3/cgnv6/stateful-firewall/tcp/stun-timeout/"
    get_url = "/axapi/v3/cgnv6/stateful-firewall/tcp/stun-timeout/%<port>s+%<port-end>s"
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/cgnv6/stateful-firewall/tcp/stun-timeout/%<port>s+%<port-end>s"
    port_end = new_resource.port_end
    stun_timeout_val_port_range = new_resource.stun_timeout_val_port_range
    uuid = new_resource.uuid
    port = new_resource.port
