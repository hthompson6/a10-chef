resource_name :a10_enable_management_service_telnet_acl_v6
...
action :create do
    ...
    post_url = "/axapi/v3/enable-management/service/telnet/acl-v6/"
    get_url = "/axapi/v3/enable-management/service/telnet/acl-v6/%<acl-name>s"
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/enable-management/service/telnet/acl-v6/%<acl-name>s"
    tunnel_cfg = new_resource.tunnel_cfg
    management = new_resource.management
    uuid = new_resource.uuid
    acl_name = new_resource.acl_name
