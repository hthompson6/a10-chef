resource_name :a10_sys_ut_state_next_state_case_action
...
action :create do
    ...
    post_url = "/axapi/v3/sys-ut/state/%<name>s/next-state/%<name>s/case/%<case-number>s/action/"
    get_url = "/axapi/v3/sys-ut/state/%<name>s/next-state/%<name>s/case/%<case-number>s/action/%<direction>s"
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/sys-ut/state/%<name>s/next-state/%<name>s/case/%<case-number>s/action/%<direction>s"
    direction = new_resource.direction
    uuid = new_resource.uuid
    drop = new_resource.drop
    udp = new_resource.udp
