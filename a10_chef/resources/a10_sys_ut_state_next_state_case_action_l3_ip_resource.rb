resource_name :a10_sys_ut_state_next_state_case_action_l3_ip
...
action :create do
    ...
    post_url = "/axapi/v3/sys-ut/state/%<name>s/next-state/%<name>s/case/%<case-number>s/action/%<direction>s/l3/ip/"
    get_url = "/axapi/v3/sys-ut/state/%<name>s/next-state/%<name>s/case/%<case-number>s/action/%<direction>s/l3/ip/%<src-dst>s"
    ve = new_resource.ve
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/sys-ut/state/%<name>s/next-state/%<name>s/case/%<case-number>s/action/%<direction>s/l3/ip/%<src-dst>s"
    ve = new_resource.ve
    virtual_server = new_resource.virtual_server
    src_dst = new_resource.src_dst
    nat_pool = new_resource.nat_pool
