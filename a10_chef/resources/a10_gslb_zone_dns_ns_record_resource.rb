resource_name :a10_gslb_zone_dns_ns_record
...
action :create do
    ...
    post_url = "/axapi/v3/gslb/zone/%<name>s/dns-ns-record/"
    get_url = "/axapi/v3/gslb/zone/%<name>s/dns-ns-record/%<ns-name>s"
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/gslb/zone/%<name>s/dns-ns-record/%<ns-name>s"
    sampling_enable = new_resource.sampling_enable
    ns_name = new_resource.ns_name
    uuid = new_resource.uuid
    ttl = new_resource.ttl
