resource_name :a10_cgnv6_service_group

property :a10_name, String, name_property: true
property :shared_partition, String
property :protocol, ['tcp','udp']
property :uuid, String
property :user_tag, String
property :shared_group, String
...
action :create do
    ...
    post_url = "/axapi/v3/cgnv6/service-group/"
    get_url = "/axapi/v3/cgnv6/service-group/%<name>s"
    shared_partition = new_resource.shared_partition
    protocol = new_resource.protocol
    uuid = new_resource.uuid
    user_tag = new_resource.user_tag
    shared_group = new_resource.shared_group
    sampling_enable = new_resource.sampling_enable
    member_list = new_resource.member_list
    health_check = new_resource.health_check
    a10_name = new_resource.a10_name

    params = { "service-group": {"shared-partition": shared_partition,
        "protocol": protocol,
        "uuid": uuid,
        "user-tag": user_tag,
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/cgnv6/service-group/%<name>s"
    shared_partition = new_resource.shared_partition
    protocol = new_resource.protocol
    uuid = new_resource.uuid
    user_tag = new_resource.user_tag
