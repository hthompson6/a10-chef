resource_name :a10_interface_ethernet_ipv6_stateful_firewall
...
action :create do
    ...
    get_url = "/axapi/v3/interface/ethernet/%<ifnum>s/ipv6/stateful-firewall"
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/interface/ethernet/%<ifnum>s/ipv6/stateful-firewall"
    uuid = new_resource.uuid
    class_list = new_resource.class_list
    acl_name = new_resource.acl_name
    inside = new_resource.inside
