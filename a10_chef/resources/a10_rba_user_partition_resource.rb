resource_name :a10_rba_user_partition
...
action :create do
    ...
    post_url = "/axapi/v3/rba/user/%<name>s/partition/"
    get_url = "/axapi/v3/rba/user/%<name>s/partition/%<partition-name>s"
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/rba/user/%<name>s/partition/%<partition-name>s"
    partition_name = new_resource.partition_name
    role_list = new_resource.role_list
    uuid = new_resource.uuid
    user_tag = new_resource.user_tag
