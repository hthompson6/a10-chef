resource_name :a10_cgnv6_nat64_fragmentation_outbound
...
action :create do
    ...
    get_url = "/axapi/v3/cgnv6/nat64/fragmentation/outbound"
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/cgnv6/nat64/fragmentation/outbound"
    frag_action = new_resource.frag_action
    uuid = new_resource.uuid
