resource_name :a10_cgnv6_lsn_endpoint_independent_filtering_udp
...
action :create do
    ...
    get_url = "/axapi/v3/cgnv6/lsn/endpoint-independent-filtering/udp"
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/cgnv6/lsn/endpoint-independent-filtering/udp"
    port_list = new_resource.port_list
    uuid = new_resource.uuid
    session_limit = new_resource.session_limit
