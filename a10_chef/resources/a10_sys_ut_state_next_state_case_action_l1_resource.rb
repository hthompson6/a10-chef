resource_name :a10_sys_ut_state_next_state_case_action_l1
...
action :create do
    ...
    get_url = "/axapi/v3/sys-ut/state/%<name>s/next-state/%<name>s/case/%<case-number>s/action/%<direction>s/l1"
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/sys-ut/state/%<name>s/next-state/%<name>s/case/%<case-number>s/action/%<direction>s/l1"
    eth_list = new_resource.eth_list
    uuid = new_resource.uuid
    auto = new_resource.auto
    value = new_resource.value
