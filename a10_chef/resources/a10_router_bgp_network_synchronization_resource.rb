resource_name :a10_router_bgp_network_synchronization
...
action :create do
    ...
    post_url = "/axapi/v3/router/bgp/%<as-number>s/network/"
    get_url = "/axapi/v3/router/bgp/%<as-number>s/network/synchronization"
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/router/bgp/%<as-number>s/network/synchronization"
    network_synchronization = new_resource.network_synchronization
    uuid = new_resource.uuid
