resource_name :a10_radius_server_host_ipv4
...
action :create do
    ...
    post_url = "/axapi/v3/radius-server/host/ipv4/"
    get_url = "/axapi/v3/radius-server/host/ipv4/%<ipv4-addr>s"
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/radius-server/host/ipv4/%<ipv4-addr>s"
    ipv4_addr = new_resource.ipv4_addr
    secret = new_resource.secret
    uuid = new_resource.uuid
