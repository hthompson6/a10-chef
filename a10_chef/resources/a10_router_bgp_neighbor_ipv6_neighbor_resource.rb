resource_name :a10_router_bgp_neighbor_ipv6_neighbor
...
action :create do
    ...
    post_url = "/axapi/v3/router/bgp/%<as-number>s/neighbor/ipv6-neighbor/"
    get_url = "/axapi/v3/router/bgp/%<as-number>s/neighbor/ipv6-neighbor/%<neighbor-ipv6>s"
    ...
    params = { "ipv6-neighbor": {"activate": activate,
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/router/bgp/%<as-number>s/neighbor/ipv6-neighbor/%<neighbor-ipv6>s"
    activate = new_resource.activate
    route_refresh = new_resource.route_refresh
    ve = new_resource.ve
    weight = new_resource.weight
