resource_name :a10_sys_ut_event_action_tcp_flags
...
action :create do
    ...
    get_url = "/axapi/v3/sys-ut/event/%<event-number>s/action/%<direction>s/tcp/flags"
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/sys-ut/event/%<event-number>s/action/%<direction>s/tcp/flags"
    ece = new_resource.ece
    urg = new_resource.urg
    uuid = new_resource.uuid
    ack = new_resource.ack
