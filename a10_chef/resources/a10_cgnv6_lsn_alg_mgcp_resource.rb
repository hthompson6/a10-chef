resource_name :a10_cgnv6_lsn_alg_mgcp

property :a10_name, String, name_property: true
property :sampling_enable, Array
property :mgcp_value, ['enable']
...
action :create do
    ...
    get_url = "/axapi/v3/cgnv6/lsn/alg/mgcp"
    sampling_enable = new_resource.sampling_enable
    mgcp_value = new_resource.mgcp_value
    uuid = new_resource.uuid

    params = { "mgcp": {"sampling-enable": sampling_enable,
        "mgcp-value": mgcp_value,
        "uuid": uuid,} }
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/cgnv6/lsn/alg/mgcp"
    sampling_enable = new_resource.sampling_enable
    mgcp_value = new_resource.mgcp_value
    uuid = new_resource.uuid
