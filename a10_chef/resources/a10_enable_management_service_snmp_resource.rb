resource_name :a10_enable_management_service_snmp
...
action :create do
    ...
    get_url = "/axapi/v3/enable-management/service/snmp"
    ...
    params = { "snmp": {"tunnel-cfg": tunnel_cfg,
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/enable-management/service/snmp"
    tunnel_cfg = new_resource.tunnel_cfg
    management = new_resource.management
    uuid = new_resource.uuid
    acl_v6_list = new_resource.acl_v6_list
