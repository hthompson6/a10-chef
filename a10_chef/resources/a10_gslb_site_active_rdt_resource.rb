resource_name :a10_gslb_site_active_rdt
...
action :create do
    ...
    get_url = "/axapi/v3/gslb/site/%<site-name>s/active-rdt"
    ...
    params = { "active-rdt": {"range-factor": range_factor,
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/gslb/site/%<site-name>s/active-rdt"
    range_factor = new_resource.range_factor
    smooth_factor = new_resource.smooth_factor
    mask = new_resource.mask
    overlap = new_resource.overlap
