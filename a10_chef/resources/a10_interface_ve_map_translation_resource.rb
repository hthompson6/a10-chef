resource_name :a10_interface_ve_map_translation
...
action :create do
    ...
    post_url = "/axapi/v3/interface/ve/%<ifnum>s/map/"
    get_url = "/axapi/v3/interface/ve/%<ifnum>s/map/translation"
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/interface/ve/%<ifnum>s/map/translation"
    inside = new_resource.inside
    outside = new_resource.outside
    uuid = new_resource.uuid
