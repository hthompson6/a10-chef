resource_name :a10_interface_trunk_ipv6_router_isis
...
action :create do
    ...
    get_url = "/axapi/v3/interface/trunk/%<ifnum>s/ipv6/router/isis"
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/interface/trunk/%<ifnum>s/ipv6/router/isis"
    tag = new_resource.tag
    uuid = new_resource.uuid
