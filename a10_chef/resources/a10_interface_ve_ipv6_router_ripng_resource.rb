resource_name :a10_interface_ve_ipv6_router_ripng
...
action :create do
    ...
    get_url = "/axapi/v3/interface/ve/%<ifnum>s/ipv6/router/ripng"
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/interface/ve/%<ifnum>s/ipv6/router/ripng"
    uuid = new_resource.uuid
    rip = new_resource.rip
