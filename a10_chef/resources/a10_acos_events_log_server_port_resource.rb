resource_name :a10_acos_events_log_server_port
...
action :create do
    ...
    post_url = "/axapi/v3/acos-events/log-server/%<name>s/port/"
    get_url = "/axapi/v3/acos-events/log-server/%<name>s/port/%<port-number>s+%<protocol>s"
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/acos-events/log-server/%<name>s/port/%<port-number>s+%<protocol>s"
    health_check_disable = new_resource.health_check_disable
    protocol = new_resource.protocol
    uuid = new_resource.uuid
    user_tag = new_resource.user_tag
