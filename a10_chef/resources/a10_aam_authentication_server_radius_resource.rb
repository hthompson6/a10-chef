resource_name :a10_aam_authentication_server_radius
...
action :create do
    ...
    get_url = "/axapi/v3/aam/authentication/server/radius"
    sampling_enable = new_resource.sampling_enable
    uuid = new_resource.uuid
    instance_list = new_resource.instance_list

    params = { "radius": {"sampling-enable": sampling_enable,
        "uuid": uuid,
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/aam/authentication/server/radius"
    sampling_enable = new_resource.sampling_enable
    uuid = new_resource.uuid
    instance_list = new_resource.instance_list
