resource_name :a10_cgnv6_fixed_nat_alg_rtsp
...
action :create do
    ...
    get_url = "/axapi/v3/cgnv6/fixed-nat/alg/rtsp"
    sampling_enable = new_resource.sampling_enable
    uuid = new_resource.uuid

    params = { "rtsp": {"sampling-enable": sampling_enable,
        "uuid": uuid,} }
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/cgnv6/fixed-nat/alg/rtsp"
    sampling_enable = new_resource.sampling_enable
    uuid = new_resource.uuid
