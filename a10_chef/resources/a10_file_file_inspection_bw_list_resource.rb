resource_name :a10_file_file_inspection_bw_list
...
action :create do
    ...
    get_url = "/axapi/v3/file/file-inspection-bw-list"
    a10_name = new_resource.a10_name
    ...
    params = { "file-inspection-bw-list": {"action": a10_action,
        "dst-file": dst_file,
        "file": file,
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/file/file-inspection-bw-list"
    a10_name = new_resource.a10_name
    dst_file = new_resource.dst_file
    file = new_resource.file
    file_handle = new_resource.file_handle
