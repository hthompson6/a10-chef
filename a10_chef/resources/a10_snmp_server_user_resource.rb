resource_name :a10_snmp_server_user
...
action :create do
    ...
    post_url = "/axapi/v3/snmp-server/user/"
    get_url = "/axapi/v3/snmp-server/user/%<username>s"
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/snmp-server/user/%<username>s"
    username = new_resource.username
    auth_val = new_resource.auth_val
    group = new_resource.group
    uuid = new_resource.uuid
