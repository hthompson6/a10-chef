resource_name :a10_router_rip_distribute_list_prefix
...
action :create do
    ...
    post_url = "/axapi/v3/router/rip/distribute-list/"
    get_url = "/axapi/v3/router/rip/distribute-list/prefix"
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/router/rip/distribute-list/prefix"
    uuid = new_resource.uuid
    prefix_cfg = new_resource.prefix_cfg
