resource_name :a10_sys_ut_event_action_tcp
...
action :create do
    ...
    get_url = "/axapi/v3/sys-ut/event/%<event-number>s/action/%<direction>s/tcp"
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/sys-ut/event/%<event-number>s/action/%<direction>s/tcp"
    uuid = new_resource.uuid
    checksum = new_resource.checksum
    seq_number = new_resource.seq_number
    nat_pool = new_resource.nat_pool
