resource_name :a10_sys_ut_template_udp

property :a10_name, String, name_property: true
property :src_port_range, Array
...
action :create do
    ...
    get_url = "/axapi/v3/sys-ut/template/%<name>s/udp"
    src_port_range = new_resource.src_port_range
    ...
    params = { "udp": {"src-port-range": src_port_range,
        "uuid": uuid,
        "checksum": checksum,
        "nat-pool": nat_pool,
        "length": length,
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/sys-ut/template/%<name>s/udp"
    src_port_range = new_resource.src_port_range
    uuid = new_resource.uuid
    checksum = new_resource.checksum
    nat_pool = new_resource.nat_pool
