resource_name :a10_ip_nat_inside_source_class_list
...
action :create do
    ...
    post_url = "/axapi/v3/ip/nat/inside/source/"
    get_url = "/axapi/v3/ip/nat/inside/source/class-list"
    a10_name = new_resource.a10_name
    uuid = new_resource.uuid

    params = { "class-list": {"name": a10_name,
        "uuid": uuid,} }
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/ip/nat/inside/source/class-list"
    a10_name = new_resource.a10_name
    uuid = new_resource.uuid
