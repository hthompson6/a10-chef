resource_name :a10_import_periodic_ssl_crl

property :a10_name, String, name_property: true
property :ssl_crl, String,required: true
...
action :create do
    ...
    post_url = "/axapi/v3/import-periodic/ssl-crl/"
    get_url = "/axapi/v3/import-periodic/ssl-crl/%<ssl-crl>s"
    ...
    params = { "ssl-crl": {"ssl-crl": ssl_crl,
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/import-periodic/ssl-crl/%<ssl-crl>s"
    ssl_crl = new_resource.ssl_crl
    use_mgmt_port = new_resource.use_mgmt_port
    uuid = new_resource.uuid
    remote_file = new_resource.remote_file
