resource_name :a10_cgnv6_nat46_stateless_fragmentation_inbound

property :a10_name, String, name_property: true
property :a10_action, ['drop','ipv4','send-icmpv6']
...
action :create do
    ...
    get_url = "/axapi/v3/cgnv6/nat46-stateless/fragmentation/inbound"
    a10_name = new_resource.a10_name
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/cgnv6/nat46-stateless/fragmentation/inbound"
    a10_name = new_resource.a10_name
    uuid = new_resource.uuid
