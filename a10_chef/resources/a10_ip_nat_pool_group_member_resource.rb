resource_name :a10_ip_nat_pool_group_member
...
action :create do
    ...
    post_url = "/axapi/v3/ip/nat/pool-group/%<pool-group-name>s/member/"
    get_url = "/axapi/v3/ip/nat/pool-group/%<pool-group-name>s/member/%<pool-name>s"
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/ip/nat/pool-group/%<pool-group-name>s/member/%<pool-name>s"
    uuid = new_resource.uuid
    pool_name = new_resource.pool_name
