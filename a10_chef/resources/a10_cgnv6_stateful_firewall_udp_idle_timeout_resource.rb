resource_name :a10_cgnv6_stateful_firewall_udp_idle_timeout
...
action :create do
    ...
    post_url = "/axapi/v3/cgnv6/stateful-firewall/udp/idle-timeout/"
    get_url = "/axapi/v3/cgnv6/stateful-firewall/udp/idle-timeout/%<port>s+%<port-end>s"
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/cgnv6/stateful-firewall/udp/idle-timeout/%<port>s+%<port-end>s"
    port = new_resource.port
    port_end = new_resource.port_end
    idle_timeout_val_port_range = new_resource.idle_timeout_val_port_range
    fast = new_resource.fast
