resource_name :a10_interface_loopback_ip_rip
...
action :create do
    ...
    post_url = "/axapi/v3/interface/loopback/%<ifnum>s/ip/"
    get_url = "/axapi/v3/interface/loopback/%<ifnum>s/ip/rip"
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/interface/loopback/%<ifnum>s/ip/rip"
    receive_cfg = new_resource.receive_cfg
    uuid = new_resource.uuid
    receive_packet = new_resource.receive_packet
    split_horizon_cfg = new_resource.split_horizon_cfg
