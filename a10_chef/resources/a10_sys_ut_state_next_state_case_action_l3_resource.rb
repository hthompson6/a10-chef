resource_name :a10_sys_ut_state_next_state_case_action_l3
...
action :create do
    ...
    get_url = "/axapi/v3/sys-ut/state/%<name>s/next-state/%<name>s/case/%<case-number>s/action/%<direction>s/l3"
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/sys-ut/state/%<name>s/next-state/%<name>s/case/%<case-number>s/action/%<direction>s/l3"
    protocol = new_resource.protocol
    uuid = new_resource.uuid
    checksum = new_resource.checksum
    value = new_resource.value
