resource_name :a10_sys_ut_event_action_l2_mac
...
action :create do
    ...
    post_url = "/axapi/v3/sys-ut/event/%<event-number>s/action/%<direction>s/l2/mac/"
    get_url = "/axapi/v3/sys-ut/event/%<event-number>s/action/%<direction>s/l2/mac/%<src-dst>s"
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/sys-ut/event/%<event-number>s/action/%<direction>s/l2/mac/%<src-dst>s"
    ethernet = new_resource.ethernet
    ve = new_resource.ve
    src_dst = new_resource.src_dst
    address_type = new_resource.address_type
