resource_name :a10_cgnv6_stateful_firewall_alg_rtsp

property :a10_name, String, name_property: true
property :rtsp_value, ['disable']
...
action :create do
    ...
    get_url = "/axapi/v3/cgnv6/stateful-firewall/alg/rtsp"
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/cgnv6/stateful-firewall/alg/rtsp"
    rtsp_value = new_resource.rtsp_value
    sampling_enable = new_resource.sampling_enable
    uuid = new_resource.uuid
