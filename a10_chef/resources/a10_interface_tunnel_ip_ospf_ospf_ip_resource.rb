resource_name :a10_interface_tunnel_ip_ospf_ospf_ip
...
action :create do
    ...
    post_url = "/axapi/v3/interface/tunnel/%<ifnum>s/ip/ospf/ospf-ip/"
    get_url = "/axapi/v3/interface/tunnel/%<ifnum>s/ip/ospf/ospf-ip/%<ip-addr>s"
...
action :update do
    client = new_resource.client
    a10_name = new_resource.a10_name
    url = "/axapi/v3/interface/tunnel/%<ifnum>s/ip/ospf/ospf-ip/%<ip-addr>s"
    dead_interval = new_resource.dead_interval
    authentication_key = new_resource.authentication_key
    uuid = new_resource.uuid
    mtu_ignore = new_resource.mtu_ignore
